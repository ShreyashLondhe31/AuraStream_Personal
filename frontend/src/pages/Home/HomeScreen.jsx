...
const HomeScreen = () => {
  ...
  if(!trendingContent) return (
    <div className="h-screen text-white relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black/70 flex items-center justify-center -z-10 shimmer" onLoad={() => {setImgLoading(false)}} />
      ...
      <div className="relative h-screen text-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          ...
          <div className="flex mt-8" >
            <Link to={`/watch/${trendingContent?.id}`} className="bg-white hover:bg-white/50 text-black font-bold py-2 px-4 rounded mr-4 flex items-center" >
